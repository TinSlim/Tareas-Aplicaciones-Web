...
test_values = [["2021-03-29 13:24","ChillÃ¡n","Plaza de Armas","CristÃ³bal","2","7"]]
...
print("""<nav class="pagination is-centered" aria-label="pagination">""",file=utf8stdout)
if page_number != 0:
    print(f"""<a class="pagination-previous" href="avistamientos.py?page={str(page_number - 1)}">Previous</a>""",file=utf8stdout)
else:
    print(f"""<button class="pagination-previous" disabled>Previous</button>""",file=utf8stdout)
if page_number != max_pags:
    print(f"""<a class="pagination-next" href="avistamientos.py?page={str(page_number + 1)}">Next page</a>""",file=utf8stdout)
else:
    print(f"""<button class="pagination-next" disabled>Next page</button>""",file=utf8stdout)
