...
if form.keys() == []:
  print("""<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Vivan los Bichos</title><link rel="stylesheet" href="./../../T3/css/mystyles.css"><link rel="stylesheet" href="./../../T3/css/hero_style.css"> <script src="./../../T3/js/nuevafoto.js"></script> <script src="https://kit.fontawesome.com/929bc70b66.js" crossorigin="anonymous"></script> <script src="./../../T3/js/new_regiones_comunas.js"></script> <script src="./../../T3/js/avistamiento_singular.js"></script> <script src="./../../T3/js/validacion.js"></script> </head><body>""",file=utf8stdout)
