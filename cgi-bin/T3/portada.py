...
for resultado in query:
  ...
  print(f'<td><img src="../../T2/media/{html.escape(resultado[4])}" width="320" height="240" alt="{html.escape(resultado[5])}"></td>',file=utf8stdout) # ESTE T2 QUEDA IGUAL
  print("</tr>",file=utf8stdout)
print("</tbody>",file=utf8stdout)
print("""     </table>
    </div>
