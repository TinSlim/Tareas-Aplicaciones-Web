                ...
                for foto in resultado[1]:
                    ...
                    if contador == 0: #primera foto
                        print(f"""<div class="block tile is-ancestor mb-5">
                                        <div class="tile is-3">
                                            <img class="pointer-image" onclick="show_modal(this)" src="../../T2/media/{html.escape(foto[4])}" alt="{html.escape(foto[5])}" width="320" height="240">
                                            <div class="modal">
                                                <div class="modal-background"></div>
                                                <div class="modal-content">
                                                    <img src="../../T2/media/{html.escape(foto[4])}" alt="{html.escape(foto[5])}"  width="800" height="600">
                                                </div>
